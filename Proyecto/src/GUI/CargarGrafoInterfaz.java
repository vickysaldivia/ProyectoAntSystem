...
import funciones.FuncionStringGrafo;
import java.io.File;
 ...
 */
public class CargarGrafoInterfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 410, 30));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Hormigas.jpg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -90, 420, 390));
    ...
    private void BuscarArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarArchivoActionPerformed
        ...
        if(seleccion == JFileChooser.APPROVE_OPTION){
            ...
            if(fichero.getName().toLowerCase().endsWith(".txt")){
                ...
                this.Fichero.setText("");
                JOptionPane.showMessageDialog(null, "Archivo seleccionado inválido.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargarGrafoInterfaz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargarGrafoInterfaz().setVisible(true);
            }
        });
    }
